...
urlpatterns = [
    ...
    path('<str:token>/', UserDetailUpdateDeleteAPIView.as_view(), name='user-detail'),
    path('partner/<str:token>/', PartnerDetailUpdateDeleteAPIView.as_view(), name='partner-detail'),
